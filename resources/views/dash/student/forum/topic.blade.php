                                    ...
                                    <div class="nk-msg-head">
                                        ...
                                        <div class="nk-msg-head-meta">
                                            ...
                                            <ul class="nk-msg-actions">
                                                <li><a href="{{ route('student.lesson',$topic_read->lesson->id)}}" class="btn btn-dim btn-sm btn-outline-light"><em class="icon ni ni-left"></em><span>Go To Lesson</span></a></li>
                                        ...
                                        <div class="nk-reply-item">
                                            <div class="nk-reply-header">
                                                <div class="user-card">
                                                    ...
                                                    <div class="user-name">{{ $topic_read->user->name }}</div>
                                                </div>
                                                <div class="date-time">{{ $topic_read->created_at->format('d M Y G i') }}</div>
                                            </div>
