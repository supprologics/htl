                ...
                <div class="toggle-wrap nk-block-tools-toggle">
                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            ...
                            <li><a onclick="approve_lesson()" class="btn btn-success btn-dim btn-outline-primary"><em class="icon ni ni-reports"></em><span>Approve</span></a></li>
                            <li><a onclick="reject_lesson()" class="btn btn-danger btn-dim btn-outline-primary"><em class="icon ni ni-reports"></em><span>Reject</span></a></li>
                        ...
                        <div class="card-inner">
                            <div class="user-card user-card-s2">
                                ...
                                <div class="user-info">
                                    ...
                                    <h5>{{$lesson->lecturer->name}}</h5>
                                    <span class="sub-text">{{$lesson->lecturer->email}}</span>
                                </div>
                            </div>
                        </div><!-- .card-inner -->
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function approve_lesson(){
            $.ajax({
                type:'POST',
                url: "{{ route('lesson.approve') }}",
                data:{
                    'id':lesson_id,
                },
                success: function(data) {
        ...
        function reject_lesson(){
            $.ajax({
                type:'POST',
                url: "{{ route('lesson.reject') }}",
                data:{
                    'id':lesson_id,
                },
                success: function(data) {
