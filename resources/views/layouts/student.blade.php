...
<head>
    ...
    <link id="skin-default" rel="stylesheet" href="{{ asset('/admin/css/theme1.css?ver=2.0.0') }}">
    ...
    <div class="nk-app-root">
        ...
        <div class="nk-main ">
            <!-- sidebar @s -->
                ...
                @include('layouts.stu_includes.sidenav')
            ...
            <div class="nk-wrap ">
                <!-- main header @s -->
                    ...
                    @include('layouts.stu_includes.headernav')
                ...
                <!-- footer @s -->
                    ...
                    @include('layouts.stu_includes.footer')
